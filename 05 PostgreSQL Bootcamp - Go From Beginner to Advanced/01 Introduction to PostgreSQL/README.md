...
## 01 Install sample data files on server
...
## 02 Install Human Resources (hr) database
...
## 03 Install sample stocks market data
...
get file in [\_data](https://github.com/Yousefess/ZTM-Udemy-Courses/tree/main/05%20PostgreSQL%20Bootcamp%20-%20Go%20From%20Beginner%20to%20Advanced/_data) with `stocks_prices` name and run it.

## 04 Install northwind database
...
1. Only superuser and database owner can execute the DROP DATABASE statement.
2. Super super carefull whenever you try to use anything starting with 'DROP'

*/

-- 1. Let's create a sample dataset called 'db_test'
