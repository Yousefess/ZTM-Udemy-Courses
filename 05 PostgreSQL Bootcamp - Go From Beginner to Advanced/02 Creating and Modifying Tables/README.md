...
## 01 Creating the movie database and a actors table
...
## 02 Creating the directors table
...
## 03 Creating the movies table with a foreign key
...
## 04 Creating the movies_revenues table
...
## 05 Creating a Junction table with movies and actors tables
...
## 06 Install sample data for `movies` database
...
## 07 Deleting tables from a database
