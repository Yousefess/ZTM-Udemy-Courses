...
-- CYCLE in Descending Sequence (like here) When reaches MINVALUE, reset to MAXVALUE
CREATE SEQUENCE seq_des
INCREMENT -1
MINVALUE 1
MAXVALUE 3
...
-- ALTER COLUMN columnname SET DEFAULT nexval(sequencename)
ALTER TABLE users2
ALTER COLUMN user2_id SET DEFAULT nextval('users2_user2_id_seq');

INSERT INTO users2 (user2_name)
VALUES ('ADNAN2');
